...
do_test "$GPAC -i $src:FID=GEN:#ClampDur=9.6:#m=m1 reframer:SID=GEN:xs=0,9.6,19.2::props=#PStart=0,#PStart=9.6:#m=m2,#PStart=19.2:#m=m3 @ enc:c=aac @ -o $dst:stl:segdur=1.920:profile=onDemand:template=\$m\$_\$Type\$_\$Number\$" "dash-pcont"
