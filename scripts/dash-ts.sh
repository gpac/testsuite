...
#force a PCR init to avoid random PCR init value
do_test "$GPAC -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_I25_baseline_1280x720_512kbps.264:#Representation=1 -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_audio.aac:#Representation=1 -o $TEMP_DIR/file.mpd:segdur=4s:m2ts --pcr_init=10000 --pcr_init=pes_pack=none" "ts-dash"
...
#force a PCR init to avoid random PCR init value
do_test "$GPAC -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_I25_baseline_1280x720_512kbps.264:#Representation=1 -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_audio.aac:#Representation=1 -o $TEMP_DIR/file.mpd:segdur=4s:m2ts:profile=onDemand --pcr_init=10000 --pcr_init=pes_pack=none" "ts-dash"
...
#force a PCR init to avoid random PCR init value
do_test "$GPAC -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_I25_baseline_1280x720_512kbps.264:#Representation=1 -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_audio.aac:#Representation=1 -o $TEMP_DIR/file.mpd:segdur=4s:m2ts:profile=live:subs_sidx=5 --pcr_init=10000 --pcr_init=pes_pack=none" "ts-dash"
...
#force a PCR init to avoid random PCR init value
do_test "$GPAC -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_I25_baseline_1280x720_512kbps.264 -i $EXTERNAL_MEDIA_DIR/counter/counter_30s_audio.aac -o $TEMP_DIR/file.mpd:segdur=4s:m2ts:profile=live --pcr_init=10000 --pcr_init=pes_pack=none" "ts-dash"
