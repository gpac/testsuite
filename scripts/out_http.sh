...
do_test "$MP4BOX -run-for 3000 -dash-live 1000 -subdur 1000 -time-shift 2 -profile live $TEMP_DIR/source.mp4 -out http://127.0.0.1:8080/live.$2:hmode=push$3 -logs=http@debug" "dash_push"
