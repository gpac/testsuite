...
do_test "$MP4BOX -profile live -dash 1000 $EXTERNAL_MEDIA_DIR/counter/counter_30s_I25_baseline_1280x720_512kbps.264 $EXTERNAL_MEDIA_DIR/counter/counter_30s_audio.aac $MEDIA_DIR/auxiliary_files/subtitle.srt:webtt -out $TEMP_DIR/live.mpd" "dash"
